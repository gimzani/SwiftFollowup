...
export default class UserAccount {
  ...
  init(options) {
    ...
    this.login_on = new Date(options.login_on).toISOString() || this.login_on;
    ...
    this.email_verified_on = new Date(options.email_verified_on).toISOString() || this.email_verified_on;
