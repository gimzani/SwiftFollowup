...
INSERT INTO "useraccount" (code, email_address, password_hash, login_on, login_count, is_active, plan_code, created_on, updated_on) VALUES
  ('01KYMCCQK7ZSPY3MFJCWES307V', 'gimzani@gmail.com',  '$argon2id$v=19$m=65536,t=3,p=1$w/VmAMAUwOzZY8pP+ttR5g$5oqRQohcNRIZGpIpZ+cHlbW2EUS+umi+lIwicjDkfs8', '2025-08-01', 0, true, 'SF_P_APPADMIN',    '2025-08-01', '2025-08-01'),
  ('01KZK6MDKM1DQB7MSSSX7GRMR5', 'jrhall22@gmail.com', '$argon2id$v=19$m=65536,t=3,p=1$yseb5UfLTJ00AXQVK/LdAA$lK6bmo2Kw1HzzvxCbIZugvZqj7vDsTW62D+ukD5wWzI', '2025-08-01', 0, true, 'SF_P_CONNECTIONS', '2025-08-01', '2025-08-01');


-- User Profiles
INSERT INTO "userprofile" (useraccount_id, first_name, last_name, middle_name, title, suffix, company, job_title, web_address, mobile_number, mailing_address, avatar_url, preferences, is_default) VALUES
  (
    (SELECT id FROM "useraccount" WHERE code = '01KYMCCQK7ZSPY3MFJCWES307V'),
    'Benjamin', 'Hall', 'Scott', NULL, NULL, 'Swift Followup, LLC', 'Founder and CEO', 'https://swiftfollowup.com', '3176968375', '', NULL, NULL, true
  ),
  (
    (SELECT id FROM "useraccount" WHERE code = '01KZK6MDKM1DQB7MSSSX7GRMR5'),
    'Julie', 'Hall', 'Renee', NULL, NULL, 'Fantasy Trove, LLC', 'Founder and CEO', 'https://fantasytrove.com', '3176507009', '', NULL, NULL, true
  );
